...
<main class="container">
    <div class="main-detail-vente row">
        ...
        <% } else if (!(boolean)request.getAttribute("enCours")&&(lastEnchere!=null)){ %>
        <h2 class="vente_title">L'enchère est terminée.</h2>
        ...
        <% } else if (!(boolean)request.getAttribute("enCours")&&(lastEnchere==null)){ %>
        <h2 class="vente_title">L'enchère est terminée.</h2>
        <h2 class="vente_subtitle">Recherchez des articles similaires pour trouver votre bonheur !</h2>
        <% } %>
        ...
        <div class="main-detail-article col-md-7 col-12 row g-3">
            ...
            <div class=" col-8"><%= article.getMiseAprix() %> pts</div>
